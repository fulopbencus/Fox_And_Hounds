...
public class Config {
    ...
    Command foxDownLeftCommand(){
        return new FoxDownLeftCommand(gameState(), foxPutPerformer(),mapPrinter(mapUtil(), printWrapper()),printWrapper(),gameState().getMapVo(),houndMove());
    }
    @Bean
    Command foxDownRightCommand(){
        return new FoxDownRightCommand(gameState(), foxPutPerformer(),mapPrinter(mapUtil(), printWrapper()),printWrapper(),gameState().getMapVo(),houndMove());
    }
    @Bean
    Command foxUpLeftCommand(){
        return new FoxUpLeftCommand(gameState(), foxPutPerformer(),mapPrinter(mapUtil(), printWrapper()),printWrapper(),gameState().getMapVo(),houndMove());
    }
    @Bean
    Command foxUpRightCommand(){
        return new FoxUpRightCommand(gameState(), foxPutPerformer(),mapPrinter(mapUtil(), printWrapper()),printWrapper(),gameState().getMapVo(),houndMove());
    }
    @Bean
